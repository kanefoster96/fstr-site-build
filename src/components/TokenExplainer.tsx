...
const DEFAULT_STEPS: ExplainerStep[] = [
  ...
  { key: "book", variant: "gold", title: "Use it to book", body: "Spend your token on a weekday slot up to six weeks ahead, or one of three Saturday slots. Booking closes midday the day before. Can't see a time? Just message me." },
